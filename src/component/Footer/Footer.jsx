    ...
    <section>
       <div className="mt-10 flex flex-col bg-opacity-95 bg-[#FFA500] justify-center">
        <div className="flex flex-col items-center">
          <div className="font-bold text-center pt-10 text-xl md:text-2xl md:font-normal text-white">
              <p>Be the first to know what happens at</p>
          </div>
          <div className="font-bold text-center text-xl md:text-2xl text-white md:font-normal">
              <p>gartekcloude! Subscribe Now</p>
          </div>
          <div className=" flex flex-row bg-white h-10 md:h-16 px-4 w-[75%] lg:w-[30%] rounded-lg items-center p-1 mt-5 justify-center">
            <input type="text" className="grow w-full disabled:true focus:outline-none rounded-lg h-full" placeholder={`Search for gartekgcloud`} />
